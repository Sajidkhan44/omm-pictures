  ...
  return (
    <div className=" min-h-[100vh] px-8 flex flex-col items-center  py-[100px] lg:w-[90%] mx-auto">
      ...
      <p className="font-medium text-2xl description-second overflow-hidden">The areas that we're specialized in.</p>
        ...
        <div className=" grid md:grid-cols-2 grid-cols-1 gap-6 mt-12 w-[100%] mx-auto ">
          {
              work.map(type => (
                <div key={type.title} className="max-w-full card group overflow-hidden rounded-[20px]  max-h-[1000px] relative">
                  ...
                  <div className=" absolute  top-0 px-6 py-12 flex items-end right-0 bottom-0 left-0 bg-gradient-to-t from-black to-transparent">
                    ...
                    <Link href={type.href} className=' px-2 py-2 w-[max-content] rounded-xl font-medium bg-white flex items-center gap-1'> <img src="/icon.png" alt="" className=" w-[30px] h-[30px]" /><span className=""> Read more</span></Link>
                    </div>
