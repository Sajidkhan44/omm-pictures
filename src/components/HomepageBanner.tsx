            ...
            <SwiperSlide key={image.src} className=' w-full h-full relative'>
                ...
                <div className=" absolute top-0 p-8 flex items-end justify-center right-0 left-0 bottom-0 bg-gradient-to-t from-black to-transparent ">
                  <div className=" text-white space-y-4 md:w-[60%] text-center">
                    <h6 className=" font-medium text-slate-400">PHOTOGRAPHY & FILM MAKING</h6>
                    <h1 className=" font-bold md:text-5xl space-x-1 text-3xl flex items-center justify-center"><img src="/icon.png" alt="" className="bg-white rounded-full  w-[35px] h-[35px]" />  <span className="">MM PICTURES</span></h1>
                    <p className=" text-sm font-medium ">Capture the essence of every moment with our premier photography studio. At OMM Studios, we specialize in creating stunning visual narratives that preserve your cherished memories forever. Our team of highly skilled photographers and state-of-the-art equipment ensure that every image we capture is a true masterpiece.</p>
                  </div>
                </div>
            </SwiperSlide>
        ))
